...
def collect_twitter_data(country,lang,date_from,date_to):
    ...
    full_query = "q={formatted_query}&result_type=recent&since={date_from}&lang={lang}&until={date_to}&count=50".format(formatted_query=urllib.parse.quote(raw_query, safe=''),lang=lang,date_from=date_from,date_to=date_to)
